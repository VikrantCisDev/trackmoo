      ...
      <div className="loginFormSec">
        <div className="formWrapper">
          <div className="formLogoTxt text-center">
            ...
            <p>
              Enter your email or phone and password to sign in your account
            </p>
          </div>
          <div className="formInputField w-100">
            <Input
              inputWrapperClass="mb-20"
              iconLeft={
                <img className="img-fluid" src={mail} alt="Email Icon" />
              }
              type="email"
            ...
            <Input
              inputWrapperClass="mb-20"
              iconRight={
                <img className="img-fluid" src={eyesClose} alt="Email Icon" />
              }
              iconLeft={
                <img className="img-fluid" src={password} alt="Email Icon" />
              }
              type="password"
              inputFieldClass="input-field"
            ...
            <div className="loginBtn">
              ...
              <div className="signUpTxt text-center mt-3 mb-4">
                <p>
                  ...
                  <a href="#" className="text-decoration-none fw-semi-bold">
                    {" "}
                    Sign up now.
                  </a>{" "}
                </p>
